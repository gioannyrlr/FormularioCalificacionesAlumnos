...
<body>
    ...
    <form action="" method="post">
        <label>Tarjetas de datos</label>
        <input type="number" name="cant" id="input" placeholder="Cantidad"><br>
        <input type="submit" name="inputs" id="button" value="Continuar"><br><br>
    </form>
...
?>
            ...
            <a href="index.php"><input type="button" name="limpiar" id="button" value="Limpiar"></a>
        </form>
</body>
</html>
